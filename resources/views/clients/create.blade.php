        ...
        <div class="form-section">
            <div class="section-header">
                ...
                <div>
                    ...
                    <p class="section-description">Enter the client's basic contact details</p>
                </div>
            </div>
        ...
        <div class="form-section">
            <div class="section-header">
                ...
                <div>
                    ...
                    <p class="section-description">Classify the client type and status</p>
                </div>
            </div>
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <select id="client_type" name="client_type" required>
                        ...
                        <option value="both" {{ old('client_type') == 'both' ? 'selected' : '' }}>Both (Buyer & Seller)</option>
                    </select>
                    @error('client_type')
                        <span class="error-message">{{ $message }}</span>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <select id="client_status" name="client_status" required>
                        ...
                        <option value="active" {{ old('client_status', 'active') == 'active' ? 'selected' : '' }}>Active</option>
                        <option value="inactive" {{ old('client_status') == 'inactive' ? 'selected' : '' }}>Inactive</option>
                        <option value="blacklisted" {{ old('client_status') == 'blacklisted' ? 'selected' : '' }}>Blacklisted</option>
                    </select>
                    @error('client_status')
                        <span class="error-message">{{ $message }}</span>
                    @enderror
                    ...
                    <select id="assigned_to" name="assigned_to">
                        ...
                        @if(isset($dealers))
                            @foreach($dealers as $dealer)
                                <option value="{{ $dealer->id }}" {{ old('assigned_to') == $dealer->id ? 'selected' : '' }}>
                                    {{ $dealer->name }}
                                </option>
                            @endforeach
                        @endif
