...
<div class="page-header">
    ...
    <p class="page-subtitle">Create a new block in a society</p>
</div>
...
<form method="POST" action="{{ route('blocks.store') }}" id="blockForm">
    @csrf
        ...
        <div class="form-section">
            <div class="section-header">
                ...
                <div>
                    ...
                    <p class="section-description">Enter the block details</p>
                </div>
            </div>
            ...
            <div class="form-grid">
                ...
                <div class="form-group full-width">
                    ...
                    <textarea id="description" name="description" rows="4"
                              placeholder="Enter block description">{{ old('description') }}</textarea>
                    @error('description')
                        <span class="error-message">{{ $message }}</span>
                    @enderror
                </div>
