...
<div class="page-header">
    ...
    <h1 class="page-title">Add New Dealer</h1>
        ...
        <div class="form-section">
            <div class="section-header">
                ...
                <div>
                    ...
                    <p class="section-description">Enter dealer details</p>
                </div>
            </div>
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="cnic" name="cnic" value="{{ old('cnic') }}" placeholder="e.g., 12345-1234567-1">
                </div>

                <div class="form-group">
                    <label for="license_number">License Number</label>
                    <input type="text" id="license_number" name="license_number" value="{{ old('license_number') }}" placeholder="Enter license number">
                </div>

                <div class="form-group">
                    <label for="default_commission_rate">Commission Rate (%) *</label>
                    <input type="number" id="default_commission_rate" name="default_commission_rate" value="{{ old('default_commission_rate', 2) }}" placeholder="e.g., 2" step="0.01" min="0" max="100" required>
                </div>

                <div class="form-group">
                    <label for="specialization">Specialization</label>
                    <select id="specialization" name="specialization">
                        <option value="all" {{ old('specialization', 'all') == 'all' ? 'selected' : '' }}>All</option>
                        <option value="plots" {{ old('specialization') == 'plots' ? 'selected' : '' }}>Plots</option>
                ...
                <div class="form-group full-width">
                    ...
                    <textarea id="remarks" name="remarks" rows="3" placeholder="Enter any notes or remarks">{{ old('remarks') }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="form-section">
            <div class="section-header">
                ...
                <div>
                    ...
                    <p class="section-description">Enter bank account information</p>
                </div>
            </div>
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text" id="bank_name" name="bank_name" value="{{ old('bank_name') }}" placeholder="e.g., HBL, UBL">
                </div>

                <div class="form-group">
                    <label for="account_number">Account Number</label>
                    <input type="text" id="account_number" name="account_number" value="{{ old('account_number') }}" placeholder="Enter account number">
                </div>

                <div class="form-group">
                    <label for="account_title">Account Title</label>
                    <input type="text" id="account_title" name="account_title" value="{{ old('account_title') }}" placeholder="Account holder name">
                </div>

                <div class="form-group">
                    <label for="iban">IBAN</label>
                    <input type="text" id="iban" name="iban" value="{{ old('iban') }}" placeholder="Enter IBAN">
                </div>
            </div>
        </div>

        <div class="form-actions">
            <a href="{{ route('dealers.index') }}" class="btn btn-light">
